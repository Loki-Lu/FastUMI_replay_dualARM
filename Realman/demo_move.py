...
import numpy as np
import time
from realman.python3.ik_rbtdef import *
from realman.python3.ik_rbtutils import *
...
if __name__ == '__main__':
    ...
    left_pose = [0.0, 0.0, 0.5, 3.14, -1.57, 0.0]
    ...
    left_robot.Movej_P_Cmd(left_pose, 100, 0, trajectory_connect=0, block=True)
    time.sleep(5)
